...
export default function VibeAiMaster() {
  ...
  if (systemState.isMobile) {
    if (mobilePage === 'landing') return <MobileLanding langKey={language} setLangKey={setLanguage as any} onAuthOpen={() => setIsAuthOpen(true)} user={user} onNavigate={handleMobileNavigate} />;
