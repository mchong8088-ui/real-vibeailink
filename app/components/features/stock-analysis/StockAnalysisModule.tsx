...
export const StockAnalysisModule: React.FC<StockAnalysisModuleProps> = ({
  ...
  if (isLoading) {
    return (
      <div style={{ backgroundColor: 'white', borderRadius: '12px', padding: '16px', textAlign: 'center' }}>
        ...
        <p style={{ fontSize: '12px', color: '#6B7280' }}>{t?.analyzingMarket || 'Analyzing market...'}</p>
      </div>
    );
  }
    ...
    if (active && payload && payload.length) {
      return (
        <div style={{ 
          ...
          <p style={{ fontSize: '8px', color: '#6B7280', margin: 0 }}>{label}</p>
          <p style={{ fontSize: '10px', fontWeight: 'bold', color: '#1F2937', margin: '2px 0 0 0' }}>${payload[0].value.toFixed(2)}</p>
        </div>
      );
    }
    return null;
  ...
  return (
    <div style={{ maxWidth: '100%', overflowX: 'hidden' }}>
      ...
      {/* SECTION 1: GLOBAL MARKET INDICES - Yellow background */}
      ...
      <div style={{ backgroundColor: '#FEF08A', borderRadius: '10px', padding: '8px', marginBottom: '8px' }}>
        ...
        {/* Local Stock Info - 1 row of 3 columns */}
        ...
        {/* Chart - Reduced height for mobile */}
        <div style={{ width: '100%', height: isMobile ? '100px' : '160px' }}>
      ...
      {/* SECTION 4: AI ANALYSIS TEXT - Reduced height */}
      <div style={{ backgroundColor: '#1F2937', borderRadius: '10px', padding: '8px' }}>
        ...
        {/* Scrollable Text Area - Reduced maxHeight to 100px */}
        <div style={{ backgroundColor: '#374151', borderRadius: '8px', padding: '8px', maxHeight: '100px', overflowY: 'auto' }}>
          {summaryText ? (
