...
const MobileAnalysis: React.FC<MobileAnalysisProps> = ({
  ...
  return (
    <div style={{ 
      ...
      {/* TOP BAR - Fixed with reduced padding */}
      <div style={{ 
      ...
      {/* SCROLLABLE CONTENT AREA - Reduced height by making it smaller */}
      <div style={{ 
        flex: '0 1 auto',
        overflowY: 'auto', 
        overflowX: 'hidden',
        ...
        minHeight: 0,
        maxHeight: 'calc(100dvh - 130px)'  // Reserve space for header + footer
      }}>
      ...
      {/* BOTTOM INPUT BAR - Tighter spacing, closer buttons */}
      {isAnalysisMode && !legalTitle && (
        <div style={{ 
          backgroundColor: 'white', 
          ...
          {/* Control Buttons Row - Smaller, closer together */}
